...
from unsup_seg.backbones.backbone import get_backbone
from unsup_seg.utils import UnsupervisedMetrics
from unsup_seg.data import Image
from unsup_seg.modules import SegmentationHead, ClusterLookup, ContrastiveCorrelationLoss, KMeans

class UnsupSeg(pl.LightningModule):
    """
    ...
    def validation_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            ...
            self.validation_step_outputs.append(return_obj)
            return return_obj
