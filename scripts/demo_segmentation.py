...
from unsup_seg.utils import prep_args, flexible_collate, get_transform
from unsup_seg.data import UnlabeledImageFolder, create_cityscapes_colormap
...
def my_app(cfg: DictConfig) -> None:
    ...
    model = UnsupSeg.load_from_checkpoint(cfg.model_path)
